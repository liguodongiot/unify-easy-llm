...
echo "cd $PROJECT_PATH && deepspeed --num_gpus=$gpu_num train.py --train_args_file $TRAIN_ARGS_PATH"
cd $PROJECT_PATH && deepspeed --num_gpus=$gpu_num train.py --train_args_file $TRAIN_ARGS_PATH
